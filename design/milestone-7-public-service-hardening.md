...
- **Staff reporting (SFC):** the "Alert Staff" flow from the official client — report a user/channel to F-List staff with recent log context attached (decided in the M6 feature-parity audit: a hosted client should let users reach F-List staff).
