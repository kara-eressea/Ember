...
> "EmberChat" is a working title. Status: **alpha** — the core feature set (milestones 1–11), the phone client, web push, and the desktop app are implemented and released (v0.26.0); pre-1.0, expect rough edges. See [`design/milestones.md`](design/milestones.md).
